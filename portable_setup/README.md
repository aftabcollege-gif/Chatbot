...
دیتابیس PGlite به‌صورت خودکار همراه برنامه ساخته می‌شود و حساب سوپرادمین اولیه
دارد: نام کاربری `admin` و رمز `ChangeMe123!`. این رمز صرفاً برای ورود اول است؛
باید بلافاصله پس از نخستین ورود تغییر داده شود و نباید در محیط عملیاتی استفاده شود.
